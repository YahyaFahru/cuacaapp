...
public class ViewCuaca extends AppCompatActivity {
    private PrefManager prefManager;
    private final String url = "https://api.openweathermap.org/data/2.5/weather";
    private final String appid = "6389fd0be75468b1a6d729f56501f3e7";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prefManager.delete();
                startActivity(new Intent(ViewCuaca.this, Cuaca.class));
                finish();
            }
        });
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, tempUrl, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        ...
                        Glide.with(ViewCuaca.this).load("https://openweathermap.org/img/wn/"+icon+"@2x.png").into(des);
